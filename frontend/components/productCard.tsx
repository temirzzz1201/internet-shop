...
import { Card, CardBody, CardFooter, Text, Heading, Image, Stack, Divider, ButtonGroup, Button, GridItem } from '@chakra-ui/react'
      ...
      <Card maxW='sm'>
        <CardBody>
          ...
          <Stack mt='6' spacing='3'>
            <Heading color='blue.600' size='md'>{product.name}</Heading>
